    ...
    <ExpandableChat size="md" position="bottom-right">
      <ExpandableChatHeader className="bg-muted/60 flex-col text-center justify-center">
        ...
        <div className="flex gap-2 items-center pt-2">
          <Button variant="secondary" className="flex justify-center items-center border-2 border-gray-300" onClick={() => setMessages([])}>
            <MessageCirclePlus size={20} className="mr-2"/>New Chat
          </Button>
        </div>
      </ExpandableChatHeader>
      <ExpandableChatBody>
